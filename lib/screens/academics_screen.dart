    ...
    return Scaffold(
      ...
      body: TabBarView(
        ...
        children: [
                              ...
                              children: [
                                ...
                                const ListTile(
                                  leading: CircleAvatar(
                                    ...
                                    child: Text('A', style: TextStyle(color: Color(0xFF6B4EFF), fontWeight: FontWeight.bold)),
                                  ),
                                  title: Text('data', style: TextStyle(fontWeight: FontWeight.bold, color: Color(0xFF1C1A24))),
                                  subtitle: Text('COS 201 • 2 Credit Units', style: TextStyle(color: Color(0xFF787587), fontSize: 12)),
                                ),
                                const SizedBox(height: 12),
                                OutlinedButton.icon(
                                  onPressed: () => _showSemesterFormDialog(context),
          ...
          // GPA Trend Tab Placeholder
          const Center(
            child: Text(
              'GPA Trend Analytics Available',
