...
public final class zzgs implements zzgx {
    ...
    public final void zza(int i3, zzgd zzgdVar, zzue... zzueVarArr) throws zzce {
        ...
        try {
            ...
            zzgdVar.zzc().zze(i3, Proxy.newProxyInstance(clsZza.getClassLoader(), new Class[]{clsZza}, new zzfy(new zzgr(zzgdVar, str, iIntValue), strZza, objZza4)));
        } catch (Exception e3) {
            throw new zzce(6, 20, e3);
        }
    }
}
