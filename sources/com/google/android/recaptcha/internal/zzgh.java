...
public final class zzgh implements zzgx {
    ...
    public final void zza(int i3, zzgd zzgdVar, zzue... zzueVarArr) throws zzce {
        ...
        try {
            zzgdVar.zzc().zze(i3, objZza instanceof String ? String.valueOf(((String) objZza).charAt(iIntValue)) : objZza instanceof List ? ((List) objZza).get(iIntValue) : Array.get(objZza, iIntValue));
        } catch (Exception e3) {
            if (!(e3 instanceof ArrayIndexOutOfBoundsException)) {
                throw new zzce(4, 23, e3);
            }
