...
final class zzlj implements zzov {
    ...
    private final void zzR(int i3) throws zznn {
        if (this.zza.zzd() != i3) {
            throw new zznn("While parsing a protocol message, the input ended unexpectedly in the middle of a field.  This could mean either that the input has been truncated or that an embedded message misreported its own length.");
        }
    }

    private final void zzS(int i3) throws zznm {
        if ((this.zzb & 7) != i3) {
            throw new zznm("Protocol message tag had invalid wire type.");
        }
    }

    private static final void zzT(int i3) throws zznn {
        if ((i3 & 3) != 0) {
            throw new zznn("Failed to parse the message.");
        }
    }

    private static final void zzU(int i3) throws zznn {
        if ((i3 & 7) != 0) {
            throw new zznn("Failed to parse the message.");
        }
    }
    ...
    public final void zzK(List list, boolean z2) throws zznm {
        int iZzm;
        int iZzm2;
        if ((this.zzb & 7) != 2) {
            throw new zznm("Protocol message tag had invalid wire type.");
