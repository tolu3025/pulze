...
public final class zzaen {
    ...
    public static C0704u zza(FirebaseAuth firebaseAuth, zzaas zzaasVar, A a3) {
        zzu.zza(firebaseAuth);
        zzu.zza(zzaasVar);
        Pair<String, String> pair = zza.get(17078);
        return new C0704u((String) pair.first, (String) pair.second, C1156o.x(zzaasVar, firebaseAuth, a3));
    }

    private static String zzb(int i3) {
        Pair<String, String> pair = zza.get(i3);
        return pair != null ? (String) pair.second : "An internal error has occurred.";
    }

    public static boolean zzc(Exception exc) {
        if (exc instanceof C0697q) {
            return ((C0697q) exc).a().endsWith("INVALID_RECAPTCHA_TOKEN");
        }
        return false;
    }
    ...
    public static boolean zzd(Exception exc) {
        if (exc instanceof C0697q) {
            return ((C0697q) exc).a().endsWith("MISSING_RECAPTCHA_TOKEN");
        }
        return false;
    }
    ...
    public static boolean zzb(Exception exc) {
        if (exc instanceof C0697q) {
            return ((C0697q) exc).a().endsWith("APP_NOT_AUTHORIZED");
        }
        return false;
    }
    ...
    private static String zza(String str, Status status) {
        ...
        return String.format(str + " [ %s ]", status.u());
    }
    ...
    */
    public static k0.C0999m zza(com.google.android.gms.common.api.Status r3) {
        /*
            Method dump skipped, instruction units count: 556
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.internal.p002firebaseauthapi.zzaen.zza(com.google.android.gms.common.api.Status):k0.m");
    }

    public static C0999m zza(Status status, AbstractC0679h abstractC0679h, String str, String str2) {
        int iT = status.t();
        if (iT != 17012 && iT != 17007 && iT != 17025) {
            return zza(status);
        }
        return new C0710x(zza(iT), zza(zzb(iT), status)).d(abstractC0679h).e(str);
    }

    public static boolean zza(Exception exc) {
        if (exc instanceof C0697q) {
            return ((C0697q) exc).a().endsWith("ALTERNATE_CLIENT_IDENTIFIER_REQUIRED");
        }
        return false;
    }
}
