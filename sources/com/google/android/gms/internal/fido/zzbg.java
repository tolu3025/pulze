...
public final class zzbg extends zzbh implements NavigableMap {
    ...
    private final zzbg zzl(int i3, int i4) {
        ...
        return i3 == i4 ? zzg(((zzbi) this.zze).zza) : new zzbg(this.zze.zzu(i3, i4), this.zzf.subList(i3, i4), null);
    }
    ...
    */
    ...
    public final zzbg headMap(Object obj, boolean z2) {
        ...
        obj.getClass();
        return zzl(0, zzbuVar.zzs(obj, z2));
    }
    ...
    public final zzbg tailMap(Object obj, boolean z2) {
        zzbu zzbuVar = this.zze;
        obj.getClass();
        return zzl(zzbuVar.zzt(obj, z2), this.zzf.size());
    }
