...
/* JADX INFO: renamed from: com.google.android.play.integrity.internal.j, reason: case insensitive filesystem */
/* JADX INFO: loaded from: classes.dex */
public abstract class AbstractC0660j {

    /* JADX INFO: renamed from: a, reason: collision with root package name */
    private static final G f5892a = new G("PhoneskyVerificationUtils");
    ...
    private static boolean c(Signature[] signatureArr) {
        if (signatureArr == null || (signatureArr.length) == 0) {
            f5892a.e("Phonesky package is not signed -- possibly self-built package. Could not verify.", new Object[0]);
            return false;
        }
        for (Signature signature : signatureArr) {
            String strA = AbstractC0659i.a(signature.toByteArray());
